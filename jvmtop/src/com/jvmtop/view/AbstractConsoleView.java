...
public abstract class AbstractConsoleView implements ConsoleView {
	 ...
	 *
	 * implement automatic scale to bigger units if this makes sense (e.g.
	 ...
	 *
	 * implement automatic scale (e.g. 1d 7h instead of 31:13m)
	 * 
	 * @param millis
	 * @return
	 */
	...
	/**
	 * Formats number of milliseconds to a HH:MM:SS representation
	 *
	 * implement automatic scale (e.g. 1d 7h 18s instead of 31:13m:18s)
	 * 
	 * @param millis
	 * @return
	 */
	public String toHHMMSS(long millis) {
		StringBuilder sb = new StringBuilder();
		Formatter formatter = new Formatter( sb );
		formatter.format( "%2d:%2dm:%2ds", millis / 1000 / 3600, (millis / 1000 / 60) % 60, (millis / 1000) % 60 );
		formatter.close();
		return sb.toString();
	}
